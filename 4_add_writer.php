...
<body>
    ...
    <br/><br/>
            <form class="contact100-form validate-form" action="4_add_writer.php" method="post" name="form1">
    ...
    if(isset($_POST['Submit'])) {
        ...
        $result = mysqli_query($mysqli, "INSERT INTO writer_tb(name,gender,address,phone_number) VALUES('$name','$gender','$address','$phone_number')");

        echo "User added successfully. <a href='4_index_writer.php'>View Users</a>";
    }
    ?>
        </div>
    </div>
